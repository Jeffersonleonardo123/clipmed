class FinancialsController < ApplicationController
  ...
  private
    ...
    def financial_params
      params.require(:financial).permit(:company_id, :user_id, :conditions_payments, :way_payments_id, :client_id, :date_vencto, :status, :category, :date_receiopt, :value_document, :value_ticket, :interest, :discount, :addition, :reference, :parcel)
    end
end
